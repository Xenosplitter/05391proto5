...
function draw()
{
  ...
  if (startTime!=0)
  {
    ...
    stroke(0)
    rect(width/2-createCanvasOfInputArea/2, height/2+createCanvasOfInputArea/4, createCanvasOfInputArea/3, createCanvasOfInputArea/4)
    rect(width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/3, height/2+createCanvasOfInputArea/4, createCanvasOfInputArea/3, createCanvasOfInputArea/4)
    rect(width/2-createCanvasOfInputArea/2+2*createCanvasOfInputArea/3, height/2+createCanvasOfInputArea/4, createCanvasOfInputArea/3, createCanvasOfInputArea/4)
    fill(0)
    if(predicts.length > 2) {
        text(predicts[0], width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
        text(predicts[1], width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/3+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
        text(predicts[2], width/2-createCanvasOfInputArea/2+2*createCanvasOfInputArea/3+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
    } else if (predicts.length > 1) {
        text(predicts[0], width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
        text(predicts[1], width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/3+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
        text(predicts[0], width/2-createCanvasOfInputArea/2+2*createCanvasOfInputArea/3+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
    } else {
        text(predicts[0], width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
        text(predicts[0], width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/3+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
        text(predicts[0], width/2-createCanvasOfInputArea/2+2*createCanvasOfInputArea/3+createCanvasOfInputArea/6, height/2+createCanvasOfInputArea/2.2);
    }
    console.log
...
function singleTap()
{
  ...
  if(didMouseClick(width/2-createCanvasOfInputArea/2, height/2+createCanvasOfInputArea/4, createCanvasOfInputArea/3, createCanvasOfInputArea/4)) {
    currentTyped = shorten(currentTyped.split(" ")).join(" ") + " " + predicts[0] + String(" ");
  } else if(didMouseClick(width/2-createCanvasOfInputArea/2+createCanvasOfInputArea/3, height/2+createCanvasOfInputArea/4, createCanvasOfInputArea/3, createCanvasOfInputArea/4)) {
      if (predicts.length > 1) {
        currentTyped = shorten(currentTyped.split(" ")).join(" ") + " " + predicts[1] + String(" ");
      } else {
        currentTyped = shorten(currentTyped.split(" ")).join(" ") + " " + predicts[0] + String(" ");
      }
  } else if(didMouseClick(width/2-createCanvasOfInputArea/2+2*createCanvasOfInputArea/3, height/2+createCanvasOfInputArea/4, createCanvasOfInputArea/3, createCanvasOfInputArea/4)) {
    if(predicts.length > 2) {
        currentTyped = shorten(currentTyped.split(" ")).join(" ") + " " + predicts[2] + String(" ");
    } else {
        currentTyped = shorten(currentTyped.split(" ")).join(" ") + " " + predicts[0] + String(" ");
    }
